-- ============================================================
-- MIGRATION 020 — Reapply production activation claim status fix.
--
-- The live RPC was still using the previously applied implementation.
-- This migration replaces it with the production-compatible definition.
-- Production permits pending, used, and revoked statuses only.
--
...
select '020_fix_owner_activation_claim_status applied' as status;
